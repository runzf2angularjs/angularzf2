...
return array(
    'Data doesn\'t exist' => 'La donnée n\'existe pas',
    'Impossible to add data' => 'Impossible d\'ajouter la donnée',
    'Impossible to delete data' => 'Impossible de supprimer la donnée',
    'Impossible to modify data' => 'Impossible de modifier la donnée',
    'Only \'MVC\' type accepted' => 'Seul le type \'MVC\' est pris en charge',
    'Only lowercase letters, numbers and dashes accepted' => 'Seuls les lettres minuscules, chiffres et tirets sont acceptés',
    'Only lowercase letters and underscores accepted' => 'Seuls les lettres minuscules et tirets bas sont acceptés',
    ...
    'Page not found' => 'La page demandée n\'existe pas ou a été déplacée',
    ...
    'Sorting descendant' => 'Tri décroissant',
    'Sorting ascendant' => 'Tri croissant',

    // Zend\Validator\*
    'File has an incorrect extension' => "L'extension du fichier est incorrecte",
    'File is not readable or does not exist' => "Le fichier ne peut pas être lu ou n'existe pas",
    ...
    "File '%value%' exceeds the defined ini size" => "Le fichier '%value%' dépasse la taille définie en configuration",
    ...
    "File exceeds the defined ini size" => "Le fichier dépasse la taille définie en configuration",
    ...
    // Oft\Validator\Password
    "The password is empty" => "Le mot de passe n'est pas rempli",
    "The password length should be between %min% and %max%" => "La longueur du mot de passe doit être comprise entre %min% et %max%",
    "Passwords do not match" => "Les mots de passe ne correspondent pas",
    
    // Oft\Validator\AclResource
    "'%value%' is not a valid ACL" => "'%value%' n'est pas une ressource ACL valide",
    
    // Oft\Validator\Cuid
    "Invalid CUID" => "Le CUID donné est invalide",
    
    // Oft\Validator\Json
    "The input is not a valid JSON" => "La chaîne n'est pas au format JSON",

    // Oft\Validator\Datetime
    "Date has an invalid format" => "Le format de la date est invalide",
);
